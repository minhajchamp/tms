$(document).ready(function(){
	...
	$('.addschools').on('click',function(){
		var html = '<div class="item-main"> <hr> <div class="item form-group "> <label class="control-label col-md-3 col-sm-3 col-xs-12">School Name </label> <div class="col-md-6 col-sm-6 col-xs-12"> <input type="text" class="form-control col-md-7 col-xs-12" name="schooldata['+i+'][school_name]" value=""> <div style="color:red"></div></div></div><div class="form-group"> <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">School Logo</label> <div class="col-md-6 col-sm-6 col-xs-12"> <div class="dropzone-cust dropzone-cust-multiple" data-dz-url="'+base_url+'index.php/school/file_upload" data-dz-file-array="schooldata" data-dz-file-array-index="'+i+'" data-dz-file-name="school_logo"> </div></div></div><div class="item form-group "> <label class="control-label col-md-3 col-sm-3 col-xs-12">School Port Reference</label> <div class="col-md-6 col-sm-6 col-xs-12"> <input type="text" class="form-control col-md-7 col-xs-12" name="schooldata['+i+'][school_port_reference]" value=""> <div style="color:red"></div></div></div><div class="item form-group "> <label class="control-label col-md-3 col-sm-3 col-xs-12">School Contact No</label> <div class="col-md-6 col-sm-6 col-xs-12"> <input type="text" class="form-control col-md-7 col-xs-12" name="schooldata['+i+'][school_contact_no]" value=""> <div style="color:red"></div></div></div><div class="item form-group "> <label class="control-label col-md-3 col-sm-3 col-xs-12">School Email</label> <div class="col-md-6 col-sm-6 col-xs-12"> <input type="text" class="form-control col-md-7 col-xs-12" name="schooldata['+i+'][school_email]" value=""> <div style="color:red"></div></div></div><div class="item form-group "> <label class="control-label col-md-3 col-sm-3 col-xs-12">School Address</label> <div class="col-md-6 col-sm-6 col-xs-12"> <textarea class="form-control col-md-7 col-xs-12" name="schooldata['+i+'][school_address]" value=""></textarea> <div style="color:red"></div></div></div></div>';
	...
	$('.addcampuses').on('click',function(){
		var html = '<div class="item-main"> <hr> <div class="item form-group "> <label class="control-label col-md-3 col-sm-3 col-xs-12">Campus Name<span class="required">*</span> </label> <div class="col-md-6 col-sm-6 col-xs-12"> <input type="text" class="form-control col-md-7 col-xs-12" name="campusdata['+i+'][campus_name]" required="required" value=""> <div style="color:red"></div></div></div><div class="form-group"> <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Campus Logo</label> <div class="col-md-6 col-sm-6 col-xs-12"> <div class="dropzone-cust dropzone-cust-multiple" data-dz-url="'+base_url+'index.php/campus/file_upload" data-dz-file-array="campusdata" data-dz-file-array-index="'+i+'" data-dz-file-name="campus_logo"> </div></div></div><div class="item form-group "> <label class="control-label col-md-3 col-sm-3 col-xs-12">Campus Port Reference</label> <div class="col-md-6 col-sm-6 col-xs-12"> <input type="text" class="form-control col-md-7 col-xs-12" name="campusdata['+i+'][campus_port_reference]" value=""> <div style="color:red"></div></div></div><div class="item form-group "> <label class="control-label col-md-3 col-sm-3 col-xs-12">Campus Contact No</label> <div class="col-md-6 col-sm-6 col-xs-12"> <input type="text" class="form-control col-md-7 col-xs-12" name="campusdata['+i+'][campus_contact_no]" value=""> <div style="color:red"></div></div></div><div class="item form-group "> <label class="control-label col-md-3 col-sm-3 col-xs-12">Campus Email </label> <div class="col-md-6 col-sm-6 col-xs-12"> <input type="text" class="form-control col-md-7 col-xs-12" name="campusdata['+i+'][campus_email]" value=""> <div style="color:red"></div></div></div><div class="item form-group "> <label class="control-label col-md-3 col-sm-3 col-xs-12">Campus Address</label> <div class="col-md-6 col-sm-6 col-xs-12"> <textarea class="form-control col-md-7 col-xs-12" name="campusdata['+i+'][campus_address]" value=""></textarea> <div style="color:red"></div></div></div></div>';
		$('form').append(html);
		dzInit();
		i++;
	});
	...
	$('#school_id').on('change',function(){
		...
		$('#user_school_id .options').addClass('hidden');

		$('#user_school_id .options').each(function(){
			if($(this).data('school-id') == val && $(this).data('campus-id') == ''){
				k++;
				$(this).removeClass('hidden');
			}
			if(k > 0){
				$('.representative_selection').slideDown();
			}
			else{
				$('.representative_selection').slideUp();
			}
		});
	});
	...
	$('#campus_id').on('change',function(){
		...
		$('#user_school_id .options').each(function(){
			if($('#school_id').val() == $(this).data('school-id')){
				if($(this).data('campus-id') == val || $(this).data('campus-id') == ''){
					j++;
					$(this).removeClass('hidden');
				}
				if(j > 0){
	...
	$('.tile_stats_count').on('click',function(e){
		e.preventDefault();
		$('.tile_stats_count').removeClass('tile_stats_count_active');
		$(this).addClass('tile_stats_count_active');
	...
	function appendTickets(response,animate = false){
		...
		$.each(response, function(k,v){
			...
			var ticket_created_at = dateFormat(v.ticketing_activity_at, "dddd, mmmm dS, yyyy, h:MM:ss TT");
			var port_reference = (v.campus_port_reference != null)?v.campus_port_reference : v.school_port_reference;
			var school_name = (v.school_name != null)?v.school_name : '';
			var campus_name = (v.campus_name != null)?v.campus_name : '';
			...
			html += '<div class="ticket ticketing_id_'+v.ticketing_id+' status_'+v.ticketing_current_status_name+'">';
			html += '    <div class="middle-bar">';
			html += '        <div class="">';
			html += '            <h4><b><i class="fa fa-ticket"></i> Ticket #'+v.ticketing_id+'</b> <span class="'+v.ticketing_current_status_name+'">('+v.ticketing_current_status.replace('_',' ')+')</span>: '+v.ticketing_titile+'</h4>';
			html += '        </div>';
			...
			html += '	            <p><b>Priority:</b> <b><span class="priority"><span class="label priority_'+v.priority.toLowerCase()+'" >'+v.priority+'</span></span></b></p>';
			html += '	        </div>';
			...
			html += '	        </div>';			
			html += '			<div class="ticket-sm-info">';
			html += '	            <p><b>School:</b> '+school_name+'</p>';
			html += '	        </div>';
			html += '	        <div class="ticket-sm-info no-border">';
			html += '	            <p><b>Campus:</b> '+campus_name+'</p>';
			html += '	        </div>';
			html += '	        <div class="ticket-sm-info">';
			...
			html += '	        </div>';	
			html += '	        <div class="ticket-sm-info no-border">';
			html += '	            <p><b>Generated by Dept.:</b> '+v.generated_by_department_name+'</p>';
			html += '	        </div>';	
			html += '	        <div class="ticket-sm-info no-border">';
			html += '	            <p><b>Assigned to Dept.:</b> '+v.assigned_to_department_name+'</p>';
			html += '	        </div>';												
			html += '	        <div class="ticket-sm-info">';
			...
			$('.ticket-main').find(div_id).countdown({until: ticketing_min_resolve_time, compact: true, description:'', serverSync: serverTime});

			var div_id =  '.ticketing_id_'+v.ticketing_id + ' .ticketing_max_resolve_time';
			$('.ticket-main').find(div_id).countdown({until: ticketing_max_resolve_time, compact: true, description:'', serverSync: serverTime});
		});
	...
	function  appendComments(response,animate = false){
		$.each(response, function(k,v){
			...
			var datetime = dateFormat(v.ticketing_comment_activity_at, "dddd, mmmm dS, yyyy, h:MM:ss TT");
	...
	function setViewTicketModal(response){
		...
		$('#viewTicketModal .ticketing_min_resolve_time').countdown({until: ticketing_min_resolve_time, compact: true, description:'', serverSync: serverTime});

		ticketing_max_resolve_time = new Date(ticketing_data.ticketing_max_resolve_time); 
		$('#viewTicketModal .ticketing_max_resolve_time').countdown({until: ticketing_max_resolve_time, compact: true, description:'', serverSync: serverTime});
		...
		$('#viewTicketModal .ticketing_current_status').html('<span class="'+ticketing_data.ticketing_current_status_name+'">('+ticketing_data.ticketing_current_status.replace('_',' ')+')</span>');
		$('#viewTicketModal .priority').html('<span class="label priority_'+ticketing_data.priority.toLowerCase()+'">'+ticketing_data.priority+'</span>');
		...
		if(user_type == 'user'){
			if(ticketing_data.assigned_to_user_id == user_id || ticketing_data.generated_by_user_id == user_id){
				$.each(user_statuses,function(k,v){
					selected = '';
					console.log(ticketing_data.ticketing_current_status);
					if(v.ticketing_current_status_name == ticketing_data.ticketing_current_status_name){
						selected = 'selected="selected"';
						selected_count++;
					}
					current_statuses_html += '<option '+selected+' value="'+v.ticketing_current_status_id+'">'+v.ticketing_current_status_text+'</option>';
				});		
			}
		}	
		...
		$.ajax({
			url: base_url+'notifications/read_by_ticket',
			type:'post',
			data: {ticket_id:ticketing_data.ticketing_id},
			success:function(){
				countNotifications();
			}
		});			
		...
		if(ticketing_comment_text != ''){
			$.ajax({
				...
				success : function(response){
					...
					$('.jodit_wysiwyg').css('border','none');
				},
				dataType: 'JSON'
			});
		}
		else{
			$('.jodit_wysiwyg').css('border','2px solid #ff0000bf');
		}
	});
	...
	$('.minimizeBtn').on('click',function(){
	 ...
	 function loadTaskBar(){
	 	$('.taskbar ul').html('');
		 	if(window.sessionStorage.minimzedItems != null){
			 	taskIds = window.sessionStorage.minimzedItems.split(',');
	...
	$('.notification-toggle').on('click',function(){
		$('#menu1').html('');
		var html = '<li class="read" style=""><a class="mark-read-btn"><span class="fa fa-bell-o"></span>Mark all as read</a></li>';
		//$('#menu1').prepend(html);		
		appendNotification(0);
	});
	...
	function serverTime() { 
	    var time = null; 
	    $.ajax({url: base_url+'dashboard/servertime', 
	...
	if(location.hash != ''){
		var ticket_id = location.hash.replace('#','');
		console.log(ticket_id);
		$.ajax({
			type: 'post',
			url : base_url+'dashboard/get_tickets',
			data: {id:ticket_id,ticketing_media:true,ticketing_comment:true,department_users:true,encryption:true},
			success:function(response){
				setViewTicketModal(response);
			},
			dataType:'JSON'
	...
	$('#newTicketModal select#school_id').selectize({
		sortField: 'text',
	});

	// $('#newTicketModal select#campus_id').selectize({
	// 	sortField: 'text'
	// });	
});
