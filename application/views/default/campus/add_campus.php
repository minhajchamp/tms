        ...
        <form class="form-horizontal form-label-left" method="POST" action="<?= site_url('campus/insert/').$this->uri->segment(3);?>" >
         <div class="item-main">  
           ...
           <div class="item form-group ">
             ...
             <div class="col-md-6 col-sm-6 col-xs-12">
               <input type="text" class="form-control col-md-7 col-xs-12"  name="campusdata[0][campus_port_reference]" value="">
           ...
           <div class="item form-group ">
             ...
             <div class="col-md-6 col-sm-6 col-xs-12">
               <input type="text" class="form-control col-md-7 col-xs-12"  name="campusdata[0][campus_contact_no]" value="">
           ...
           <div class="item form-group ">
             ...
             <div class="col-md-6 col-sm-6 col-xs-12">
               <input type="text" class="form-control col-md-7 col-xs-12"  name="campusdata[0][campus_email]" value="">
           ...
           <div class="item form-group ">
             ...
             <div class="col-md-6 col-sm-6 col-xs-12">
               <textarea class="form-control col-md-7 col-xs-12" name="campusdata[0][campus_address]" value=""></textarea>
