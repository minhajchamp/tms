  ...
  <div class="">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
       ...
       <div class="item form-group">
         <label class="control-label col-md-3 col-sm-3 col-xs-12" >Campus Port Reference
         </label>
         <div class="col-md-6 col-sm-6 col-xs-12">
           <input type="text" class="form-control col-md-7 col-xs-12"  name="campus_port_reference"  value="<?php echo !empty(set_value('campus_port_reference')) ? set_value('campus_port_reference') : $record->campus_port_reference ?>">
       ...
       <div class="item form-group">
         <label class="control-label col-md-3 col-sm-3 col-xs-12" >Campus Contact No
         </label>
         <div class="col-md-6 col-sm-6 col-xs-12">
           <input type="text" class="form-control col-md-7 col-xs-12"  name="campus_contact_no"  value="<?php echo !empty(set_value('campus_contact_no')) ? set_value('campus_contact_no') : $record->campus_contact_no ?>">
           <div style="color:red"><?php echo form_error('campus_contact_no'); ?></div>
         </div>
       </div>

       <div class="item form-group">
         <label class="control-label col-md-3 col-sm-3 col-xs-12" >Campus Email
         </label>
         <div class="col-md-6 col-sm-6 col-xs-12">
           <input type="text" class="form-control col-md-7 col-xs-12"  name="campus_email"  value="<?php echo !empty(set_value('campus_email')) ? set_value('campus_email') : $record->campus_email ?>">
           <div style="color:red"><?php echo form_error('campus_email'); ?></div>
         </div>
       </div>

       <div class="item form-group">
         <label class="control-label col-md-3 col-sm-3 col-xs-12" >Campus Address
         </label>
         <div class="col-md-6 col-sm-6 col-xs-12">
           <textarea class="form-control col-md-7 col-xs-12"  name="campus_address" ><?php echo !empty(set_value('campus_address')) ? set_value('campus_address') : $record->campus_address ?></textarea>
