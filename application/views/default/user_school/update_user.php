...
<div class="right_col" role="main">
    <div class="">
        ...
        <!--  <div class="x_content">-->
        <form class="form-horizontal form-label-left" method="POST" action="<?= site_url('user_school/update/') .$this->uri->segment(3)?>" >
            ...
            <div class="item form-group campus_selection " style="display: none;">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" >Campus Name 
                <div class="col-md-6 col-sm-6 col-xs-12">
                 <div class="item form-group ">
                  <select name="campus_id" id="campus_id" class="form-control" >
                    <option value="0" class="">All Campuses</option>
