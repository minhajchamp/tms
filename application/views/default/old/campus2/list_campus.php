                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="<?= site_url('campus/delete/').$record->campus_id.'/'.$this->uri->segment(2) ?>" class="fa fa-trash"></a>  <a href="<?= site_url('campus/edit/').$record->campus_id.'/'.$this->uri->segment(2);?>" class="fa fa-edit"></a></td>
                        </tr>
