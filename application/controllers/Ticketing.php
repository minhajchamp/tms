...
class Ticketing extends General_controller
{
			...
			else
			{
				...
				foreach ($this->input->post('campusdata') as $campus) {
					$data[] = array(
						...
						'campus_contact_person_name' => $campus['campus_contact_person_name'],
						'campus_contact_person_contact_no' => $campus['campus_contact_person_contact_no'],
	...
	public function update($id, $school_id = "")
	{
		...
		{     
			...
			$this->form_validation->set_rules('campus_port_reference','campus Port Reference','required|min_length[5]|max_length[40]');
			...
			{	
				...
				$data = array(
					...
					'campus_contact_person_name' => $this->input->post('campus_contact_person_name'),
					'campus_contact_person_contact_no' => $this->input->post('campus_contact_person_contact_no'),
					'campus_status'          => 'active',
					'campus_activity_by'     => $this->session->userdata('user_id')
				);
